 ...
 * [PostgreSQL](https://github.com/clalimarmo/migrate/tree/master/driver/postgres)
 * [Cassandra](https://github.com/clalimarmo/migrate/tree/master/driver/cassandra)
 * [SQLite](https://github.com/clalimarmo/migrate/tree/master/driver/sqlite3)
 * [MySQL](https://github.com/clalimarmo/migrate/tree/master/driver/mysql) ([experimental](https://github.com/clalimarmo/migrate/issues/1#issuecomment-58728186))
 * Bash (planned)

Need another driver? Just implement the [Driver interface](http://godoc.org/github.com/clalimarmo/migrate/driver#Driver) and open a PR.
...
```bash
# install
go get github.com/clalimarmo/migrate
...
See GoDoc here: http://godoc.org/github.com/clalimarmo/migrate/migrate

```go
import "github.com/clalimarmo/migrate/migrate"

// Import any required drivers so that they are registered and available
import _ "github.com/clalimarmo/migrate/driver/mysql"
